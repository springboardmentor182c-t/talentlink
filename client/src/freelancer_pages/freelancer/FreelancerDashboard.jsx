...
//               <Button variant="contained" sx={{ mt: 2, bgcolor: "#F4A623", color: "white" }}>
//                 View Details
//               </Button>
//             </Card>
//           ))}
  ...
  return (
    <FreelancerLayout>
      ...
      <Grid container spacing={3}>
            ...
            <Card key={p.id} sx={{ mb: 2, p: 2 }}>
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <Chip
                  ...
                  sx={{
                    bgcolor:
                      p.status === "In Progress" ? "#2F81E0" :
                      p.status === "Pending" ? "#F4A623" : "#4CAF50",
                    color: "white",
                    fontWeight: 700,
                  }}
                />
        ...
        {/* EARNINGS */}
        <Grid item xs={12} md={3}>
          <Typography variant="h6" sx={{ mb: 2, fontWeight: 700 }}>Earnings Summary</Typography>

          <Card sx={{ p: 2 }}>
            <Typography sx={{ fontWeight: 700, mb: 2 }}>Last 3 Months</Typography>
