...
//   useEffect(() => {
//     // Mock data for initial view if API isn't ready
//     setContracts([
//       { id: 1, title: 'Website Redesign', freelancer: 'John Doe', amount: 1200, status: 'Active' },
//       { id: 2, title: 'Mobile App UI', freelancer: 'Jane Smith', amount: 3000, status: 'Pending' }
//     ]);
//   }, []);
...
//         <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1e293b' }}>Contracts</h1>
//         <button style={{ backgroundColor: '#2563eb', color: 'white', padding: '10px 20px', borderRadius: '8px', border: 'none', fontWeight: '500' }}>
//           + New Contract
//         </button>
//       </div>
...
//             <tr>
//               <th style={{ padding: '16px', fontSize: '13px', color: '#64748b' }}>PROJECT TITLE</th>
//               <th style={{ padding: '16px', fontSize: '13px', color: '#64748b' }}>FREELANCER</th>
//               <th style={{ padding: '16px', fontSize: '13px', color: '#64748b' }}>BUDGET</th>
...
//                 <td style={{ padding: '16px' }}>{item.freelancer}</td>
