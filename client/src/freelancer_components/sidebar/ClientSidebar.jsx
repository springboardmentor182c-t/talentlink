...
//               <NavItem to="/client/dashboard" icon={<FaHome />} label="Overview" isActive={location.pathname === '/client/dashboard'} />
//               <NavItem to="/client/projects" icon={<FaBriefcase />} label="My Projects" isActive={location.pathname === '/client/projects'} />
//               <NavItem to="/client/proposals" icon={<FaUserFriends />} label="Review Proposals" isActive={location.pathname === '/client/proposals'} />
//               <NavItem to="/client/financials" icon={<FaFileInvoiceDollar />} label="Financials" isActive={location.pathname === '/client/financials'} />
//               <NavItem to="/client/contracts" icon={<FaFileContract />} label="Contracts" isActive={location.pathname === '/client/contracts'} />
//               <NavItem to="/client/documents" icon={<FaFileAlt />} label="Documents" isActive={location.pathname === '/client/documents'} />
//               <NavItem to="/client/messages" icon={<FaEnvelope />} label="Messages" isActive={location.pathname === '/client/messages'} />
//           </div>
...
//     display: 'flex',
//     flexDirection: 'column',
//     transition: 'width 0.3s ease', // Smooth open/close on desktop
//     whiteSpace: 'nowrap', // Prevents text wrapping when closing
//   },
//   logoArea: {
//     padding: '30px 25px',
//     borderBottom: '1px solid rgba(255,255,255,0.08)',
...
// import ".../App.css"; // Ensure this is imported in App.js instead
