...
//   sidebarWidth = 260,
// }) {
//   const { user, logout } = useUser(); // We don't use updateProfile here to avoid affecting Client
//   const navigate = useNavigate();
...
//     // 2. Save to separate LocalStorage keys (NOT the database)
//     // This ensures it DOES NOT change the Client Profile
