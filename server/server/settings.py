...
INSTALLED_APPS = [
    ...
    # ... django apps
    'rest_framework',
    # drf-spectacular: modern OpenAPI/Swagger generation + UI views
    'drf_spectacular',
    # keep drf_yasg if present, but prefer drf-spectacular for schema generation
    'drf_yasg',
...
# Optional spectacular settings (basic)
SPECTACULAR_SETTINGS = {
    'TITLE': 'Talentlink API',
    'DESCRIPTION': 'API schema generated by drf-spectacular',
    'VERSION': '1.0.0',
}
